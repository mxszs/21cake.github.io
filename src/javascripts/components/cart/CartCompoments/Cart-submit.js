            ...
            return(
                <div>
                   { car.length? <div className="cart-submit cart-area">
                                ...
                                <div className="cart-total"><span>合计：¥<span>{allprice}</span></span></div>
                                {allprice < 100-0?<span className="cart-balance" id="cost-freight-tip">满¥ 100免配送费，还差¥45元，<a href="/">去加购 &gt;&gt;</a> </span>:<span className="cart-balance" id="cost-freight-tip">订单已满￥100元,享免费配送服务</span>}
